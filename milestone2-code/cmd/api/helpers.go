...
// // envelope wraps up responses in a named object.
...
func writeJSON(w http.ResponseWriter, status int, data any, headers http.Header) error {
	...
	js, err := json.Marshal(data) // use: json.MarshalIndent(data, " ", "\t") for pretty responses
	if err != nil {
		return err
	}
...
func readJSON(w http.ResponseWriter, r *http.Request, dst any) error {
	...
	// We call the DisallowUnknownFields() method on it
	...
	if err != nil {
		...
		// We mucked up and passed an unsupported value to Decode().
		// This is an *unexpected error* which we *shouldn't* see during normal operation.
